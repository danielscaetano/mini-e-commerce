...
<body>
    ...
    <form method="POST" id="formulario"action="{{ route('categorias.update', [$loja->id, $categoria->id]) }}">
        @csrf
        @method('PUT')
        <x-layout>
            <x-slot:title>
                ...
                <div class="card bg-base-100 shadow mt-8">
                    <div class="card-body">
                        ...
                        <div class="form-control w-full">
                            <textarea name="nome_categoria" class="textarea textarea-bordered w-full resize-none" rows="4" maxlength="255"
